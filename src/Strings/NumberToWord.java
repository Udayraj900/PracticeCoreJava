...
class NumberToWord {
	...
	private static Set<Integer> numberSet = new TreeSet<Integer>((Comparator<Integer>) (i1, i2) -> i2 - i1);
	...
	public static void main(String[] args) {
		...
		System.out.println(getNumberInWord(23));
		System.out.println(getNumberInWord(8763));
		System.out.println(getNumberInWord(123410982));
	}
